...
"""Type definitions for vLLM-Omni engine components.

This module provides msgspec structs and dataclasses used for serialization
and communication between pipeline stages.
"""
